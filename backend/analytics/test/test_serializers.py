...
class SystemStatsSerializerTest(TestCase):
    ...
    def test_serializer_fields(self):
        ...
        expected_fields = [
            ...
            'total_groups', 'total_workouts', 'workouts_today', 'workouts_this_week',
            'workouts_this_month', 'total_meals', 'meals_today', 'meals_this_week',
            'meals_this_month', 'total_posts', 'total_comments', 'total_likes',
            'posts_today', 'posts_this_week', 'pending_reports', 'average_user_level',
