...
class SystemAnalyticsServiceTest(TestCase):
    ...
    def test_get_system_stats(self):
        ...
        self.assertIn('new_users_this_month', stats)
        self.assertIn('new_users_this_week', stats)
        self.assertIn('new_users_today', stats)
        self.assertIn('total_clients', stats)
        self.assertIn('new_clients_this_month', stats)
        self.assertIn('new_clients_this_week', stats)
        self.assertIn('new_clients_today', stats)
        ...
        self.assertIn('posts_this_week', stats)
        self.assertIn('posts_this_month', stats)
        self.assertIn('total_comments', stats)
        self.assertIn('comments_today', stats)
        self.assertIn('comments_this_week', stats)
        self.assertIn('comments_this_month', stats)
        self.assertIn('total_likes', stats)
        self.assertIn('likes_today', stats)
        self.assertIn('likes_this_week', stats)
        self.assertIn('likes_this_month', stats)
